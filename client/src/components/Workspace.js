...
function Workspace() {
    ...
    useEffect(() => {
        ...
        else if(lang==='py')
        {
            ...
            setCode(`Please Select your preferred language...`);
        }
    },[lang]);    
    ...
    const handleRun = async (e) => {
        ...
        try {
            ...
            const norows = newOut.split("\r\n");             // (carriage return and newline) characters as the separator
                        ...
                        <div className="tab-content" id="pills-tabContent">
                            ...
                            >
                                <div className="d-flex justify-content-between align-items-center">
                                    ...
                                    {Q ? <h5 className=" fw-semibold" style={{ color: Q.difficulty === "Easy" ? "#02ab02" : Q.difficulty === "Medium" ? "#FFA116" : "red" }}>{Q ? Q.difficulty : null}</h5> : null}
                                </div>
                                <hr />
                        ...
                        <div className="d-flex justify-content-between py-2">
                            <div className="col-md-3 ms-2">
                                <select onChange={(e) => change(e.target.value)} id="inputState" className="select">
                                    ...
                                    <option className='text-white' value="py">Python3</option>
                                </select>
                            </div>
                            <div>
